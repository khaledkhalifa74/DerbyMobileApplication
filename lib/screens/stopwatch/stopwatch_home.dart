import 'package:champions/global_components/answers_bottom_sheet.dart';
                        ...
                        Expanded(
                          child: ListView(
                            children: [
                              ...
                              CustomContent(
                                contentText: snapshot.data!.docs[currentIndex][AppStrings.questionFBTitle],
                              ),
                            ],
                          ),
                        ),
                            ...
                            itemCallBack: () {
                              showModalBottomSheet(
                                ...
                                builder: (context) => AnswersBottomSheet(
                                  player1: snapshot.data!.docs[currentIndex][AppStrings.answer1FBTitle],
                                  player2: snapshot.data!.docs[currentIndex][AppStrings.answer2FBTitle],
                                  player3: snapshot.data!.docs[currentIndex][AppStrings.answer3FBTitle],
                                  player4: snapshot.data!.docs[currentIndex][AppStrings.answer4FBTitle],
                                  player5: snapshot.data!.docs[currentIndex][AppStrings.answer5FBTitle],
                                  player6: snapshot.data!.docs[currentIndex][AppStrings.answer6FBTitle],
                                  player7: snapshot.data!.docs[currentIndex][AppStrings.answer7FBTitle],
                                  player8: snapshot.data!.docs[currentIndex][AppStrings.answer8FBTitle],
                                  player9: snapshot.data!.docs[currentIndex][AppStrings.answer9FBTitle],
                                  player10:snapshot.data!.docs[currentIndex][AppStrings.answer10FBTitle],
                                ),
                              );
                            },
                          ),
